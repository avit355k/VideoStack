...
const AllCds = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://videostack.onrender.com/api/v1/get-cd-videos");
  ...
  return (
    <div className='bg-zinc-900 px-4 sm:px-6 md:px-8 lg:px-12 py-8 text-white h-auto'>
      <h1 className='text-2xl text-white font-serif font-bold mb-8'>ALL CDS</h1>
      {isLoading ? (
        <Loader />
      ) : (
        <>
