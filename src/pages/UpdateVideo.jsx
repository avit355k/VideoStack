...
const UpdateVideo = () => {
    ...
    const submit = async () => {
        try {
            if (
                ...
                const response = await axios.put("https://videostack.onrender.com/api/v1/update-video", Data, { headers });
                ...
                navigate(`/view-video-details/${id}`);
            }
        } catch (error) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`https://videostack.onrender.com/api/v1/get-video-by-id/${id}`, { headers });
